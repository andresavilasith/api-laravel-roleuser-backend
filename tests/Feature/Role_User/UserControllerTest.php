...
class UserControllerTest extends TestCase
{
    ...
    public function test_user_index()
    {
        ...
        $response->assertJsonStructure(['users_list'])->assertStatus(200);
    }
    ...
    public function test_user_show()
    {
        ...
        $response->assertJsonStructure(['user', 'roles'])->assertStatus(200);
    }
    ...
    public function test_user_update_with_role()
    {
        ...
        $response->assertJsonStructure(['message', 'user'])->assertStatus(200);
    }
